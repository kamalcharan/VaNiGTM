-- ============================================================
-- KI-Prime — Product-Specific Migrations (KI_ prefix)
-- Run AFTER framework base migrations (VN_ tables)
-- ============================================================
...
CREATE POLICY ki_client_isolation ON ki_clients
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_portfolio_isolation ON ki_portfolios
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_holding_isolation ON ki_holdings
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_txn_isolation ON ki_transactions
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_goal_isolation ON ki_goals
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_projection_isolation ON ki_goal_projections
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
CREATE POLICY ki_alert_isolation ON ki_alerts
    FOR ALL USING (tenant_id::text = current_setting('app.tenant_id', true));
