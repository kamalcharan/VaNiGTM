...
const tiers = [
  {
    ...
    price: '0',
    features: ['1 active mission', 'Core GTM agents', 'Ideal customer & persona builder', 'Email outreach', '1 seat'],
  ...
  },
  {
    ...
    price: '199',
    features: ['Unlimited missions & contacts', 'All channels + AI search visibility', 'API access', 'SSO & audit logs', 'Unlimited seats', 'Dedicated success manager'],
