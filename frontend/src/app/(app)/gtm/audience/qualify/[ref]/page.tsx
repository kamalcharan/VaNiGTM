 ...
 *
 * It is also addressable. `/gtm/audience/qualify/PROS-0042` can be sent to someone —
...
export default function DossierPage() {
    ...
    return (
      <div className="page">
        ...
        <div className="body">
          ...
          />
          <VdfButton variant="outline" onClick={() => router.push('/gtm/audience/qualify')}>
            Back to prospects
          </VdfButton>
        </div>
      </div>
  ...
  return (
    <div className="page">
      ...
      <div className="body">
        <button className={s.back} onClick={() => router.push('/gtm/audience/qualify')}>
          ← All prospects
        </button>
